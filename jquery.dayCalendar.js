/*
jQuery.dayCalendar v.0.0.1
Copyright (c) 2013 nemuzuka - son.ga.yo@gmail.com
MIT License Applies
*/
...
(function (jQuery) {
    ...
    jQuery.fn.dayCalendar = function () {
    ...
    function build(options) {
		...
		function build() {
			...
			//表示する幅、１日辺りの幅から、最小表示期間日数を計算
			var minDays = Math.floor((opts.slideWidth / opts.cellWidth)  + 5);
			//データ中の最大、最小日付を抽出し、最小表示期間日数を加味して描画開始日付、終了日付を求める
			//期間が最小表示期間日数よりも少ない場合、最小表示日数が適用される
